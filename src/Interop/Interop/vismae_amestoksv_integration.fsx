...
// TODO: theres an ordering issue here... if multiple suppliers are in amesto, and match visma, they have to be in the same order
//       Visma.[0] and Amesto.[0] have to line up.  If Visma.[0] and Amesto.[1] match they will be ignored...
